            ...
            <div className={twoColumn ? "flex gap-4" : ""}>
              ...
              >
                ...
                <textarea
                  ...
                  className={`w-full sentient-regular min-h-screen h-auto resize-none focus:outline-none text-lg text-left transition-all duration-0
                    ${isDark ? "bg-[#222]" : lightModeBg}
