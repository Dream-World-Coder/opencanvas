...
const AboutPage = ({ bgClr = "bg-cream-light" }) => {
    ...
    return (
        <>
            ...
            >
                <Header noBlur={true} exclude={["/about", "/photo-gallery"]} />
                ...
                leading-tight tracking-normal max-w-2xl mx-auto"
                        >
                            OpenCanvas is an open canvas for your creativity.
                            It’s a platform where you can share any form of
                            written art—poems, narrations, stories, articles,
                            journals, and more. Express the philosophy and
                            emotions behind your work, giving your words deeper
                            meaning. Organize your creations into albums and
                            collections to showcase a specific journey or theme.
                            Explore a world of artistic expression, connect with
                            like-minded dreamers, and discover inspiring works
                            from fellow artists.
                        </p>
                    </div>
