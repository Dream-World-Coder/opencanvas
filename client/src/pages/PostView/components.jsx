    ...
    const loadReplies = async (commentId) => {
        ...
        try {
            ...
            setReplies((prev) => [
                ...prev.filter(
                    (r) =>
                        r.parentCommentId.toString() !== commentId.toString(),
                ),
                          ...
                          <div key={comment._id}>
                              ...
                              <div className="pl-8">
                                  {isReplyExpanded(comment._id) &&
                                      ...
                                      getFetchedReplies(comment._id).map(
                                          (reply) => (
                                              <Comment
                                                  key={reply._id}
                                                  comment={reply}
                    ...
                    <div className="dark:text-white px-2 pb-4 pt-0 text-sm w-full flex items-center justify-between">
                        <span>
                            ...
                            <u>
                                @
                                {
                                    parentCommentRef.current?.authorSnapshot
                                        .username
                                }
                            </u>
                        </span>
              ...
              ${darkTheme.primaryText}`}
                ...
                <ReactMarkdown
                  ...
                  ${isDark ? "border-[#999] text-[#ddd]" : "border-gray-400 text-gray-700"}`}
                        ...
                        h1: ({ children }) => {
                            const plainText =
                                extractTextFromReactChildren(children);
                            return (
                                <h1
                                    id={generateId(children)}
