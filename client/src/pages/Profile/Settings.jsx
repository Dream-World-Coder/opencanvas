...
const ProfileSettings = () => {
    ...
    async function updateUser() {
        ...
        try {
            ...
            if (
                formValues.fullName?.length > 32 ||
                formValues.fullName?.length < 4
            ) {
                ...
                <AlertDialog>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                This will remove your current session. You can
            ...
            <div className="space-y-6 dark:text-white">
                <div className="rounded-lg border p-6 text-center space-y-4 dark:border-[#333] dark:bg-[#222]">
                    ...
                    <p className="text-sm text-black dark:text-gray-100 mt-1">
                        Opencanvas is an open source project, free to use from
                        GitHub.
                        <br />
                        However, please support the maintenance and deployment
                        cost if you can.
                    </p>
