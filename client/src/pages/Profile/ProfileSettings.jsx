  ...
  const account = {
    ...
    content: (
      <div className="space-y-6 dark:text-white">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <p className="text-sm font-medium">
                    <u>Device</u>: {getDeviceInfo(item.deviceInfo).device}
                  </p>
                  <p className="text-sm font-medium">
                    <u>Operating System</u>: {getDeviceInfo(item.deviceInfo).os}
                  </p>
                  <p className="text-sm font-medium">
                    <u>Browser</u>: {getDeviceInfo(item.deviceInfo).browser}
                  </p>
                  <p className="text-sm font-medium">
                    <u>ip Address</u>: {item.ipAddress || "N/A"}
                  </p>
                  <p className="text-sm font-medium">
                    <u>Date</u>: {formatDateDetails(item.loginTime)}
                  </p>
                </div>
                {index === 0 && (
        ...
        <Card className="border-none shadow-none dark:bg-[#171717] dark:text-white">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="rounded-lg border border-red-200 dark:border-red-900 p-4 dark:bg-[#222]">
  ...
  return (
    <>
      ...
      <div className="w-full h-full bg-white dark:bg-[#171717] dark:text-white">
        <div className="mx-auto max-w-4xl pt-24 px-4 pb-4 dark:bg-[#171717]">
          ...
          <div className="mb-4 block sm:hidden">
            <select
              ...
              className="w-full p-2 rounded-md border border-gray-300 dark:border-gray-700 dark:bg-[#171717] dark:text-white focus:ring-lime-500 focus:border-lime-500"
            >
          ...
          <Tabs
            ...
            className="space-y-6"
          >
            <Card className="dark:bg-[#171717] dark:border-[#333]">
