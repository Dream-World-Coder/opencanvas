...
export const useDataService = () => {
    ...
    const getUserPosts = async (userId, page = 1) => {
        const res = await authAxios.get(
            `/u/${userId}/posts?page=${page}&limit=20`,
        );
        return res.data; // { data, total }
    };
    ...
    const voteOnPost = async (postId, vote) => {
        try {
            const res = await authAxios.post("/post/like-dislike", {
                postId,
                vote,
            });
            return res.data;
    ...
    const deletePost = async (postId) => {
        try {
            ...
            const res = await authAxios.delete("/post/delete", {
                data: { postId },
            });
            return res.data;
        } catch (err) {
    ...
    const getComment = async (commentId) => {
        try {
            ...
            toast.error(
                err.response?.data?.message || "Error fetching comment",
            );
            throw err;
        }
    };
    ...
    const addComment = async (postId, content) => {
        try {
            const res = await authAxios.post("/new-comment", {
                postId,
                content,
            });
    ...
    const editComment = async (commentId, content) => {
        try {
            const res = await authAxios.put("/edit-comment", {
                commentId,
                content,
            });
    ...
    const getCollection = async (collectionId) => {
        try {
            ...
            toast.error(
                err.response?.data?.message || "Error fetching collection",
            );
            throw err;
        }
    };
    ...
    const createCollection = async (collectionData) => {
        try {
            ...
            toast.error(
                err.response?.data?.message || "Error creating collection",
            );
            throw err;
        }
    };
    ...
    const updateCollection = async (collectionId, collectionData) => {
        try {
            ...
            toast.error(
                err.response?.data?.message || "Error updating collection",
            );
            throw err;
        }
    };
    ...
    const voteOnCollection = async (collectionId, vote) => {
        try {
            ...
            toast.error(
                err.response?.data?.message || "Error voting on collection",
            );
            throw err;
        }
    };
    ...
    const deleteCollection = async (collectionId) => {
        try {
            ...
            toast.error(
                err.response?.data?.message || "Error deleting collection",
            );
            throw err;
        }
    };
